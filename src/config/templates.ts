...
export const TEMPLATES: WidgetTemplate[] = [
  ...
  {
    label: 'Metrics: Server Cluster Status (List)',
    config: {
      id: 'tpl-list-mock-nodes',
      type: 'list',
      label: 'Server Cluster Status',
      api: '/api/mock?type=list-nodes',
      method: 'GET',
      responsePath: 'data.nodes',
      size: 'md',
      description: 'Real-time status of server nodes via mock API',
      refreshInterval: 10000,
      config: {
  ...
  {
    label: 'Metrics: Deployment Progress (Progress)',
    config: {
      id: 'tpl-progress-mock-deploy',
      type: 'progress',
      label: 'Deployment v2.5',
      api: '/api/mock?type=progress-task',
      method: 'GET',
      responsePath: 'data.current',
      size: 'sm',
      description: 'Stage 4: Edge Distribution',
      refreshInterval: 5000,
      config: {
        target: 100,
        suffix: '%',
  ...
  {
    label: 'Metrics: Database Health (Status)',
    config: {
      id: 'tpl-status-mock-db',
      type: 'status',
      label: 'Database Cluster',
      api: '/api/mock?type=status-health',
      method: 'GET',
      responsePath: 'status',
      size: 'sm',
