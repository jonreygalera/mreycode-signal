        ...
        {isVisible && (
          <motion.div
            ...
            className={cn(
              ...
              "bg-[#131722] border border-[#2a2e39] text-foreground text-xs font-mono",
          ...
          >
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 border-[7px] border-transparent border-b-[#2a2e39] -translate-y-px -z-10" />
          </motion.div>
        )}
      </AnimatePresence>
    </div>
